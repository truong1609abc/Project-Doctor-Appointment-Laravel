...
<<<<<<< HEAD
                    <input type="text" class="form-control" name="name_doctor" id="name_doctor" placeholder="Nhập tên">
=======
...
<<<<<<< HEAD
                    <input type="email" class="form-control" name="doctor_email" id="doctor_email" placeholder="Nhập email">
=======
...
<<<<<<< HEAD
                    <input type="date" class="form-control" name="doctor_date" id="doctor_date" placeholder="Nhập ngày sinh">
                  </div>
...
<<<<<<< HEAD
                    <input type="int" class="form-control" name="phone" id="phone" placeholder="Nhập Số điện thoại">
                  </div>
=======
...
<<<<<<< HEAD
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="doctor_degree" id="doctor_degree" placeholder="Nhập bằng cấp">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">Doctor_export</label>
                    <input type="text" class="form-control" name="doctor_export" id="doctor_export" placeholder="Nhập">
=======
                    @error('star')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
